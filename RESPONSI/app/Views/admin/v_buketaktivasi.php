                        ...
                        <tbody class="bg-white text-dark">
                            ...
                            <tr id="<?= $isi['buket_id'];?>" gambar="<?= $isi['buket_gambar'];?>">
                                ...
                                <td style="width: 100px;" class="pl-4">
                                    <a href="<?= base_url('/admin/aktivasi/'.$isi['buket_id']) ?>" class="btn btn-sm btn-outline-secondary">Aktivasi</a>
                                    <a href="#" data-href="<?= base_url('/admin/batal_buket/'.$isi['buket_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-sm btn-outline-danger">Batal</a>
                                </td>
                            </tr>
                            <?php 
                                endforeach;
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="#" role="button" id="delete-button" class="btn btn-danger">Tolak Bucket</a>
